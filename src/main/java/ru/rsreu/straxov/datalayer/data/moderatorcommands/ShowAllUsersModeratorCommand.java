...
public class ShowAllUsersModeratorCommand implements ActionCommand {
    ...
    public Page execute(HttpServletRequest request) {
        ...
        List<User> allUsers= userDAO.getAllUsersAndRolesModer();
        request.setAttribute(ALL_USERS, allUsers);


        path = ConfigurationManager.getProperty("path.page.moderator.users");
