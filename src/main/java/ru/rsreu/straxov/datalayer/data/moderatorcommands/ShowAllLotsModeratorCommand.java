...
public class ShowAllLotsModeratorCommand implements ActionCommand {
    private static final String ACTIVE_LOTS = "activeLots";
    @Override
    public Page execute(HttpServletRequest request) {
        ...
        List<Lot> activeLots = lotDAO.getActiveLots();
        request.setAttribute(ACTIVE_LOTS, activeLots);

        path = ConfigurationManager.getProperty("path.page.moderator.lots");
